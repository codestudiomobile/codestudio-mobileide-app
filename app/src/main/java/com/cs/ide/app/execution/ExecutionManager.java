...
public class ExecutionManager {
    ...
    public static void runFile(MainActivity activity, FileItem item) {
        ...
        // 4. Add cleanup logic to the shell command
        // We delete the entire session directory after the main command finishes
        String commandWithCleanup = String.format("%s; rm -rf \"%s\"", command, sessionDir.getAbsolutePath());

        executeInTerminal(activity, commandWithCleanup, sessionDir.getAbsolutePath(), fileName.toLowerCase());
    }
