...
public class CompileResultActivity extends AppCompatActivity implements ServiceConnection {
	...
	protected void onCreate(@Nullable Bundle savedInstanceState) {
		...
		if (terminalView == null) {
			...
			android.content.SharedPreferences prefs = getSharedPreferences(com.cs.ide.app.utils.AppPreferences.PREFERENCE_NAME, MODE_PRIVATE);
	...
	public boolean onContextItemSelected(android.view.MenuItem item) {
		...
		if (id == 10) {
			...
			if (text != null) {
				com.cs.ide.termux.shared.interact.ShareUtils.copyTextToClipboard(this, text);
			...
			if (selectedText != null) {
				com.cs.ide.termux.shared.interact.ShareUtils.shareText(this, getString(R.string.title_share_selected_text), selectedText, getString(R.string.title_share_selected_text_with));
				terminalView.setCopyMode(false);
			}
			return true;
		}
