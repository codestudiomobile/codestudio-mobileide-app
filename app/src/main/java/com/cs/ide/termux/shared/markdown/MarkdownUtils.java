package com.cs.ide.termux.shared.markdown;
...
public class MarkdownUtils {
    ...
    /**
     * Get the markdown code {@link String} for a {@link String}. This ensures all
     * backticks "`" are
     * properly escaped so that markdown does not break.
     *
     * @param string    The {@link String} to convert.
     * @param codeBlock If the {@link String} is to be converted to a code block or
     *                  inline code.
    ...
    public static String getMarkdownCodeForString(String string, boolean codeBlock) {
        ...
        // markdown requires surrounding backticks count to be at least one more than
        // the count
