...
public class MessageDialogUtils {
     ...
     *
     * @param context     The {@link Context} to use to start the dialog. An
     ...
     * @param onDismiss   The {@link DialogInterface.OnDismissListener} to run when
     *                    dialog is dismissed.
     */
     ...
     * @param onPositiveButton The {@link DialogInterface.OnClickListener} to run
     *                         when positive button
     *                         is pressed.
     * @param negativeText     The negative button text of the dialog. If this is
     *                         {@code null}, then
     *                         negative button will not be shown.
     * @param onNegativeButton The {@link DialogInterface.OnClickListener} to run
     *                         when negative button
     *                         is pressed.
     * @param onDismiss        The {@link DialogInterface.OnDismissListener} to run
