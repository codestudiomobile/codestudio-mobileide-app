...
public final class TermuxPropertyConstants {
        ...
        public static final ImmutableBiMap<String, Integer> MAP_TERMINAL_CURSOR_STYLE = new ImmutableBiMap.Builder<String, Integer>()
                        ...
                        .build();
        /**
         * Defines the key for how many days old the access time should be of jniLibs
         * that
         * should be
         * deleted from $TMPDIR on termux exit.
         * `-1` for none, `0` for all and `> 0` for x days.
         */
        public static final String KEY_DELETE_TMPDIR_FILES_OLDER_THAN_X_DAYS_ON_EXIT = "delete-tmpdir-jniLibs-older-than-x-days-on-exit"; // Default:
        // "delete-tmpdir-jniLibs-older-than-x-days-on-exit"
        ...
        public static final String DEFAULT_IVALUE_EXTRA_KEYS = "[['ESC','DRAWER','SCROLL','HOME','UP','END','PGUP'], ['TAB','CTRL','ALT','LEFT','DOWN','RIGHT','PGDN']]"; // Double
        /**
