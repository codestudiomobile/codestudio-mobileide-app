...
public class ExtraKeyButton {
     ...
     * dict to define the extra key. {popup: {key: name, ...}, ...}
     */
     ...
     * defined in
     * {@link ExtraKeysConstants#PRIMARY_KEY_CODES_FOR_STRINGS} (LEFT, RIGHT,
     * PGUP...) or some text.
     */
    ...
    /**
     * The {@link ExtraKeyButton} containing the information of the popup button
     ...
     *
     * @param config             The {@link JSONObject} containing the info to
     *                           create the {@link ExtraKeyButton}.
     ...
     * @param config             The {@link JSONObject} containing the info to
     *                           create the {@link ExtraKeyButton}.
     * @param popup              The {@link ExtraKeyButton} optional {@link #popup}
     *                           button.
     * @param extraKeyDisplayMap The {@link ExtraKeysConstants.ExtraKeyDisplayMap}
     *                           that defines the
     *                           display text mapping for the keys if a custom value
