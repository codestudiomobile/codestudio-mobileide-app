...
import com.cs.ide.termux.shared.android.ProcessUtils;
import com.cs.ide.termux.shared.android.UserUtils;
...
public class PeerCred {
    ...
    PeerCred() {
        ...
        // call somehow doesn't report failure and returns the uid of root
        pid = -1;
        uid = -1;
        gid = -1;
    }
    ...
    public void fillPname(@NonNull Context context) {
        // If jni did not set process name since it wouldn't be able to access
        // /proc/<pid> of other
        // users/apps, then try to see if any app has that pid, but this wouldn't check
        // child
