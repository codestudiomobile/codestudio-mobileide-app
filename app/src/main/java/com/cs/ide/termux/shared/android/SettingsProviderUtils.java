...
public class SettingsProviderUtils {
    ...
    /**
     * Get settings key value from {@link SettingNamespace} namespace and of
     * {@link SettingType} type.
     *
     ...
     * @return Returns the key value. This will be {@code null} if an exception is
     *         raised.
     */
    @Nullable
