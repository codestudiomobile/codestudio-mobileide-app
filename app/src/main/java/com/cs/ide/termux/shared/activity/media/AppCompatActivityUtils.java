package com.cs.ide.termux.shared.activity.media;
...
public class AppCompatActivityUtils {
     ...
     * @param name     The {@link String} representing the name for a
     *                 {@link NightMode}.
     * @param local    If set to {@code true}, then a call to
     *                 {@link AppCompatDelegate#setLocalNightMode(int)}
     *                 will be made, otherwise to
     ...
     *
     * @param activity                  The host {@link AppCompatActivity}.
     * @param showBackButtonInActionBar Set to {@code true} to enable and
