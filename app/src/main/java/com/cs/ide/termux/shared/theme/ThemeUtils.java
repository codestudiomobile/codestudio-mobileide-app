package com.cs.ide.termux.shared.theme;
...
public class ThemeUtils {
    ...
    /**
     * Will return true if mode is set to {@link NightMode#TRUE}, otherwise will
     * return true if
    ...
    /**
     * Wrapper for {@link #getSystemAttrColor(Context, int, int)} with {@code def}
     * value {@code 0}.
     */
     ...
     *                {@link Activity} or
     *                {@link AppCompatActivity} or one with which a theme attribute
     *                can be got.
