package com.cs.ide.termux.shared.jni.models;
...
/**
 * A class that can be used to return result for JNI calls with support for
 * multiple fields to easily
...
public class JniResult {
    ...
    /**
     * The errno value for any failed native system or library calls if
     * {@link #retval} does not equal 0.
     ...
     * The message will contain errno message returned by strerror() if errno was
     * set.
     *
    ...
    /**
     * Optional additional int data that needs to be returned by JNI call, like
    ...
    /**
     * Create an new instance of {@link JniResult} from a {@link Throwable} with
     * {@link #retval} -1.
     *
