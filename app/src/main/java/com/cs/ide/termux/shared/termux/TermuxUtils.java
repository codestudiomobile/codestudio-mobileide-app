package com.cs.ide.termux.shared.termux;
...
import com.cs.ide.R;
import com.cs.ide.termux.shared.termux.TermuxConstants.TERMUX_APP;
import com.cs.ide.termux.shared.android.AndroidUtils;
import com.cs.ide.termux.shared.android.PackageUtils;
...
import com.cs.ide.termux.shared.markdown.MarkdownUtils;
import com.cs.ide.termux.shared.reflection.ReflectionUtils;
...
import com.cs.ide.termux.shared.termux.file.TermuxFileUtils;
...
public class TermuxUtils {
    ...
    /**
     * Get the {@link Context} for {@link TermuxConstants#TERMUX_PACKAGE_NAME}
     * package with the
     * {@link Context#CONTEXT_RESTRICTED} flag.
     *
     * @param context The {@link Context} to use to get the {@link Context} of the
     *                package.
     * @return Returns the {@link Context}. This will {@code null} if an exception
     *         is raised.
     */
    ...
    /**
     * Get the {@link Context} for {@link TermuxConstants#TERMUX_API_PACKAGE_NAME}
     * package.
     *
     * @param context The {@link Context} to use to get the {@link Context} of the
     *                package.
    ...
    /**
     * Get the {@link Context} for {@link TermuxConstants#TERMUX_BOOT_PACKAGE_NAME}
     * package.
     *
     * @param context The {@link Context} to use to get the {@link Context} of the
     *                package.
    ...
    /**
     * Get the {@link Context} for {@link TermuxConstants#TERMUX_FLOAT_PACKAGE_NAME}
     * package.
     *
     * @param context The {@link Context} to use to get the {@link Context} of the
     *                package.
    ...
    /**
     * Get the {@link Context} for
     * {@link TermuxConstants#TERMUX_STYLING_PACKAGE_NAME} package.
     *
     * @param context The {@link Context} to use to get the {@link Context} of the
     *                package.
     * @return Returns the {@link Context}. This will {@code null} if an exception
    ...
    /**
     * Get the {@link Context} for
     * {@link TermuxConstants#TERMUX_TASKER_PACKAGE_NAME} package.
     *
     * @param context The {@link Context} to use to get the {@link Context} of the
     *                package.
     * @return Returns the {@link Context}. This will {@code null} if an exception
    ...
    /**
     * Get the {@link Context} for
     * {@link TermuxConstants#TERMUX_WIDGET_PACKAGE_NAME} package.
     *
     * @param context The {@link Context} to use to get the {@link Context} of the
     *                package.
     * @return Returns the {@link Context}. This will {@code null} if an exception
    ...
    /**
     * Wrapper for
     * {@link PackageUtils#getContextForPackageOrExitApp(Context, String, boolean, String)}.
     */
    ...
    /**
     * Check if Termux app is installed and enabled. This can be used by external
     * apps that don't
     * share `sharedUserId` with the Termux app.
     * <p>
     * If your third-party app is targeting sdk `30` (android `11`), then it needs
     * to add `com.cs.ide`
     * package to the `queries` element or request `QUERY_ALL_PACKAGES` permission
     * in its
     * `AndroidManifest.xml`. Otherwise it will get `PackageSetting{......
     * com.cs.ide/......} BLOCKED`
     ...
     * <manifest
     * <queries>
     * <package android:name="com.cs.ide" />
     * </queries>
     * </manifest>
     * }
     *
     * @param context The context for operations.
     * @return Returns {@code errmsg} if {@link TermuxConstants#TERMUX_PACKAGE_NAME}
     *         is not installed
    ...
    /**
     * Check if Termux:API app is installed and enabled. This can be used by
     * external apps that don't
     * share `sharedUserId` with the Termux:API app.
     *
     * @param context The context for operations.
     * @return Returns {@code errmsg} if
     *         {@link TermuxConstants#TERMUX_API_PACKAGE_NAME} is not installed
     *         or disabled, otherwise {@code null}.
     */
    ...
    /**
     * Check if Termux app is installed and accessible. This can only be used by
     * apps that share
     * `sharedUserId` with the Termux app.
     * <p>
     * This is done by checking if first checking if app is installed and enabled
     * and then if
     * {@code currentPackageContext} can be used to get the {@link Context} of the
     * app with
     * {@link TermuxConstants#TERMUX_PACKAGE_NAME} and then if
     * {@link TermuxConstants#TERMUX_PREFIX_DIR_PATH} exists and has
     * {@link FileUtils#APP_WORKING_DIRECTORY_PERMISSIONS} permissions. The
     * directory will not
     * be automatically created and neither the missing permissions automatically
     * set.
     *
     * @param currentPackageContext The context of current package.
     * @return Returns {@code errmsg} if failed to get termux package
     *         {@link Context} or
     *         {@link TermuxConstants#TERMUX_PREFIX_DIR_PATH} is accessible,
     *         otherwise {@code null}.
     */
    ...
    /**
     * Get a field value from the {@link TERMUX_APP#BUILD_CONFIG_CLASS_NAME} class
     * of the Termux app
     * APK installed on the device.
     * This can only be used by apps that share `sharedUserId` with the Termux app.
     * <p>
     * This is a wrapper for
     * {@link #getTermuxAppAPKClassField(Context, String, String)}.
     *
     * @param currentPackageContext The context of current package.
     * @param fieldName             The name of the field to get.
     * @return Returns the field value, otherwise {@code null} if an exception was
     *         raised or failed
     ...
     * This can only be used by apps that share `sharedUserId` with the Termux app.
     * <p>
     * This is done by getting first getting termux app package context and then
     * getting in class
     * loader (instead of current app's) that contains termux app class info, and
     * then using that to
     * load the required class and then getting required field from it.
     * <p>
     * Note that the value returned is from the APK file and not the current value
     * loaded in Termux
     * app process, so only default values will be returned.
     * <p>
     * Trying to access {@code null} fields will result in
     * {@link NoSuchFieldException}.
     *
     * @param currentPackageContext The context of current package.
     * @param clazzName             The name of the class from which to get the
     *                              field.
     * @param fieldName             The name of the field to get.
     * @return Returns the field value, otherwise {@code null} if an exception was
     *         raised or failed
    ...
    /**
     * Returns {@code true} if {@link Uri} has `package:` scheme for
     * {@link TermuxConstants#TERMUX_PACKAGE_NAME} or its sub plugin package.
     */
    ...
    /**
     * Returns {@code true} if {@link Uri} has `package:` scheme for
     * {@link TermuxConstants#TERMUX_PACKAGE_NAME} sub plugin package.
     */
    ...
    public static void sendTermuxOpenedBroadcast(@NonNull Context context) {
        ...
        // this technique is needed to work around broadcast changes that Oreo
        // introduced
     ...
     *
     * @param currentPackageContext The context of current package.
     * @param appInfoMode           The {@link AppInfoMode} to decide the app info
     *                              required.
    ...
    /**
     * Get a markdown {@link String} for the apps info of termux app, its installed
     * plugin apps or
     * external apps that called a Termux API depending on {@link AppInfoMode}
     * passed.
     * <p>
     * Also check {@link PackageUtils#isAppInstalled(Context, String, String) if
     * targetting targeting
     * sdk `30` (android `11`) since {@link PackageManager.NameNotFoundException}
     * may be thrown while
     ...
     * @param appInfoMode           The {@link AppInfoMode} to decide the app info
     *                              required.
     * @param callingPackageName    The optional package name for a plugin or
     *                              external app.
     * @return Returns the markdown {@link String}.
     */
    public static String getAppInfoMarkdownString(final Context currentPackageContext, final AppInfoMode appInfoMode,
    ...
    /**
     * Get a markdown {@link String} for the apps info of all/any termux plugin apps
     * installed.
     *
     * @param currentPackageContext The context of current package.
     * @return Returns the markdown {@link String}.
    ...
    public static String getTermuxPluginAppsInfoMarkdownString(final Context currentPackageContext) {
        ...
        if (termuxPluginAppPackageNamesList != null) {
            for (int i = 0; i < termuxPluginAppPackageNamesList.size(); i++) {
                ...
                // If the package context for the plugin app is not null, then assume its
                // installed and get its info
                if (termuxPluginAppContext != null) {
                    if (i != 0)
    ...
    /**
     * Get a markdown {@link String} for the app info. If the {@code context} passed
     * is different
     * from the {@link TermuxConstants#TERMUX_PACKAGE_NAME} package context, then
     * this function
     * must have been called by a different package like a plugin, so we return info
     * for both packages
     * if {@code returnTermuxPackageInfoToo} is {@code true}.
     *
     * @param currentPackageContext      The context of current package.
     * @param returnTermuxPackageInfoToo If set to {@code true}, then will return
     *                                   info of the
     *                                   {@link TermuxConstants#TERMUX_PACKAGE_NAME}
     *                                   package as well if its different from
     *                                   current package.
     * @return Returns the markdown {@link String}.
     */
    ...
    /**
     * Get a markdown {@link String} for the app info for the package associated
    ...
    public static String getReportIssueMarkdownString(@NonNull final Context context) {
        ...
        String markdownString = "## Where To Report An Issue" +
                ...
                "\n\n### Email\n" +
                "\n" + MarkdownUtils.getLinkMarkdownString(TermuxConstants.TERMUX_SUPPORT_EMAIL_URL,
                        TermuxConstants.TERMUX_SUPPORT_EMAIL_MAILTO_URL)
                +
                "  " +
                "\n\n### Reddit\n" +
                "\n" + MarkdownUtils.getLinkMarkdownString(TermuxConstants.TERMUX_REDDIT_SUBREDDIT,
                        TermuxConstants.TERMUX_REDDIT_SUBREDDIT_URL)
                +
                "  " +
                "\n\n### GitHub Issues for Termux apps\n" +
                "\n" + MarkdownUtils.getLinkMarkdownString(TermuxConstants.TERMUX_APP_NAME,
                        TermuxConstants.TERMUX_GITHUB_ISSUES_REPO_URL)
                +
                "  " +
                "\n" + MarkdownUtils.getLinkMarkdownString(TermuxConstants.TERMUX_API_APP_NAME,
                        TermuxConstants.TERMUX_API_GITHUB_ISSUES_REPO_URL)
                +
                "  " +
                "\n" + MarkdownUtils.getLinkMarkdownString(TermuxConstants.TERMUX_BOOT_APP_NAME,
                        TermuxConstants.TERMUX_BOOT_GITHUB_ISSUES_REPO_URL)
                +
                "  " +
                "\n" + MarkdownUtils.getLinkMarkdownString(TermuxConstants.TERMUX_FLOAT_APP_NAME,
                        TermuxConstants.TERMUX_FLOAT_GITHUB_ISSUES_REPO_URL)
                +
                "  " +
                "\n" + MarkdownUtils.getLinkMarkdownString(TermuxConstants.TERMUX_STYLING_APP_NAME,
                        TermuxConstants.TERMUX_STYLING_GITHUB_ISSUES_REPO_URL)
                +
                "  " +
                "\n" + MarkdownUtils.getLinkMarkdownString(TermuxConstants.TERMUX_TASKER_APP_NAME,
                        TermuxConstants.TERMUX_TASKER_GITHUB_ISSUES_REPO_URL)
                +
                "  " +
                "\n" + MarkdownUtils.getLinkMarkdownString(TermuxConstants.TERMUX_WIDGET_APP_NAME,
                        TermuxConstants.TERMUX_WIDGET_GITHUB_ISSUES_REPO_URL)
                +
                "  " +
                "\n\n### GitHub Issues for Termux packages\n" +
                "\n" +
                MarkdownUtils.getLinkMarkdownString(TermuxConstants.TERMUX_PACKAGES_GITHUB_REPO_NAME,
     ...
     * <p>
     * This will take a few seconds to run due to running {@code apt update}
     * command.
     *
     * @param context The context for operations.
     * @return Returns the markdown {@link String}.
    ...
    public static String geAPTInfoMarkdownString(@NonNull final Context context) {
        ...
        InputStream inputStream = context.getResources()
                .openRawResource(R.raw.apt_info_script);
        try {
    ...
    public static String getLogcatDumpMarkdownString(@NonNull final Context context) {
        ...
        // Putting a limit at 3000 lines. Assuming average 160 chars/line will result in
        // 500KB usage
        // per object.
        // That many lines should be enough for debugging for recent issues anyways
        // assuming termux
    ...
    /**
     * Get a process id of the main app process of the
     * {@link TermuxConstants#TERMUX_PACKAGE_NAME}
     * package.
     *
     * @param context The context for operations.
    ...
    /**
     * The modes used by
     * {@link #getAppInfoMarkdownString(Context, AppInfoMode, String)}.
     */
    public enum AppInfoMode {
        ...
        /**
         * Get info for Termux app and its plugins listed in
         * {@link TermuxConstants#TERMUX_PLUGIN_APP_PACKAGE_NAMES_LIST}.
         */
        TERMUX_AND_PLUGIN_PACKAGES,
        /*
         * Get info for all the Termux app plugins listed in {@link
