package com.cs.ide.termux.shared.crash;
...
public class CrashHandler implements Thread.UncaughtExceptionHandler {
    ...
    /**
     * Set uncaught crash handler of current non-main thread to
     * {@link CrashHandler}.
     */
    ...
    /**
     * Get {@link CrashHandler} instance that can be set as uncaught crash handler
     * of a non-main thread.
     */
    ...
    /**
     * Log a crash in the crash log file at path returned by
     * {@link CrashHandlerClient#getCrashLogFilePath(Context)}.
     *
    ...
    public interface CrashHandlerClient {
        ...
        /**
         * Called before
         * {@link #logCrashToFile(Context, CrashHandlerClient, Thread, Throwable)} is
         * called.
         *
         * @param context   The {@link Context} passed to
         *                  {@link CrashHandler#CrashHandler(Context, CrashHandlerClient, boolean)}.
         * @param thread    The {@link Thread} in which the crash happened.
         * @param throwable The {@link Throwable} thrown for the crash.
         * @return Should return {@code true} if crash has been handled and should not
         *         be logged,
