...
public class TermuxTerminalViewClient extends TermuxTerminalViewClientBase {
	...
	/**
	 * Should be called when {@link com.cs.ide.termux.view.TerminalView#mEmulator} is set
	 */
	@Override
	...
	public void onCopyTextToClipboard(String text) {
		mTermuxTerminalSessionActivityClient.onCopyTextToClipboard(mActivity.getCurrentSession(), text);
	}
	...
	public void shareSelectedText() {
		String selectedText = mActivity.getTerminalView().getSelectedText();
	...
	public void reportIssueFromTranscript() {
		...
		MessageDialogUtils.showMessage(mActivity, TermuxConstants.TERMUX_APP_NAME + " Report Issue",
				...
				mActivity.getString(com.cs.ide.R.string.action_yes), (dialog, which) -> reportIssueFromTranscript(transcriptText, true),
				mActivity.getString(com.cs.ide.R.string.action_no), (dialog, which) -> reportIssueFromTranscript(transcriptText, false),
				null);
	}
