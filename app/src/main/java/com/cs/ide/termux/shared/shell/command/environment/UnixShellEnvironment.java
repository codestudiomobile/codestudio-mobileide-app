package com.cs.ide.termux.shared.shell.command.environment;
...
public abstract class UnixShellEnvironment implements IShellEnvironment {
    ...
    /**
     * Environment variable for the locale category for native language, local
     * customs, and coded
     * character set in the absence of the LC_ALL and other LC_* environment
     * variables.
     */
    public static final String ENV_LANG = "LANG";

    /**
     * Environment variable for the represent the sequence of directory paths
     * separated with
     * colons ":" that should be searched in for dynamic shared libraries to link
     * programs against.
     */
    public static final String ENV_LD_LIBRARY_PATH = "LD_LIBRARY_PATH";

    /**
     * Environment variable for the represent the sequence of directory path
     * prefixes separated with
     * colons ":" that certain functions and utilities apply in searching for an
     * executable file
    ...
    /**
     * Environment variable for the absolute path of the current working directory.
     * It shall not
     * contain any components that are dot or dot-dot. The value is set by the cd
     * utility, and by
    ...
    /**
     * Environment variable for the terminal type for which output is to be
     * prepared. This information
     * is used by utilities and application programs wishing to exploit special
     * capabilities specific
     * to a terminal. The format and allowable values of this environment variable
     * are unspecified.
     */
    public static final String ENV_TERM = "TERM";

    /**
     * Environment variable for the path of a directory made available for programs
     * that need a place
     * to create temporary jniLibs.
     */
