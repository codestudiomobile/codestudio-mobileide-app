...
public class IntentUtils {
    ...
    /**
     * Get a {@link String} extra from an {@link Intent} if its not {@code null} or
     * empty.
     *
     ...
     * @param throwExceptionIfNotSet If set to {@code true}, then an exception will
     *                               be thrown if extra
     *                               is not set.
    ...
    /**
     * Get an {@link Integer} from an {@link Intent} stored as a {@link String}
     * extra if its not
     * {@code null} or empty.
     *
     * @param intent The {@link Intent} to get the extra from.
    ...
    /**
     * Get a {@link String[]} extra from an {@link Intent} if its not {@code null}
     * or empty.
     *
     * @param intent                 The {@link Intent} to get the extra from.
     * @param key                    The {@link String} key name.
