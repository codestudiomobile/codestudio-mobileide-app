package com.cs.ide.termux.shared.models;
...
/**
 * An object that stored info for
 * {@link ReportActivity}.
 */
public class ReportInfo implements Serializable {

    /**
     * Explicitly define `serialVersionUID` to prevent exceptions on
     * deserialization.
     *
     * Like when calling `Bundle.getSerializable()` on Android.
     * `android.os.BadParcelableException: Parcelable encountered IOException
     * reading a Serializable object` (name = <class_name>)
     * `java.io.InvalidClassException: <class_name>; local class incompatible`
     *
     * The `@Keep` annotation is necessary to prevent the field from being removed
     * by proguard when
    ...
    /**
     * The markdown report text prefix. Will not be part of copy and share
     * operations, etc.
     */
    ...
    /**
     * The markdown report text suffix. Will not be part of copy and share
     * operations, etc.
     */
    public String reportStringSuffix;

    /**
     * If set to {@code true}, then report header info will be added to the report
     * when markdown is
     * generated.
     */
    ...
    /**
     * The label for the report file to save if user selects
     * menu_item_save_report_to_file.
     */
    public String reportSaveFileLabel;
    /**
     * The path for the report file to save if user selects
     * menu_item_save_report_to_file.
     */
