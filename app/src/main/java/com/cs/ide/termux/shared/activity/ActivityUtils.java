package com.cs.ide.termux.shared.activity;
...
public class ActivityUtils {
     ...
     * @param logErrorMessage  If an error message should be logged if failed to
     *                         start activity.
     * @param showErrorMessage If an error message toast should be shown if failed
     *                         to start activity
     *                         in addition to logging a message. The {@code context}
     *                         must not be
     *                         {@code null}.
     * @return Returns the {@code error} if starting activity was not successful,
     *         otherwise {@code null}.
     */
    ...
    /**
     * Wrapper for
     * {@link #startActivityForResult(Context, int, Intent, boolean, boolean, ActivityResultLauncher)}.
     */
     ...
     *
     * @param context                The context for operations. It must be an
     *                               instance of {@link Activity} or
     *                               {@link AppCompatActivity}. It is ignored if
     *                               {@code activityResultLauncher}
     *                               is not {@code null}.
     * @param requestCode            The request code to use while sending intent.
     *                               This must be >= 0, otherwise
     *                               exception will be raised. This is ignored if
     *                               {@code activityResultLauncher}
     *                               is {@code null}.
     * @param intent                 The {@link Intent} to send to start the
     *                               activity.
     * @param logErrorMessage        If an error message should be logged if failed
     *                               to start activity.
     * @param showErrorMessage       If an error message toast should be shown if
     *                               failed to start activity
     *                               in addition to logging a message. The
     *                               {@code context} must not be
     *                               {@code null}.
     * @param activityResultLauncher The {@link ActivityResultLauncher<Intent>} to
     *                               use for start the
