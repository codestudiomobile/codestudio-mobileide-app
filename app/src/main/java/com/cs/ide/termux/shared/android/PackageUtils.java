package com.cs.ide.termux.shared.android;
...
import com.cs.ide.termux.shared.interact.MessageDialogUtils;
...
public class PackageUtils {
    ...
    /**
     * Get the {@link Context} for the package name with
     * {@link Context#CONTEXT_RESTRICTED} flags.
     *
     * @param context     The {@link Context} to use to get the {@link Context} of
     *                    the {@code packageName}.
     ...
     *                       of the {@code packageName}.
     * @param packageName    The package name whose {@link Context} to get.
     * @param exitAppOnError If {@code true} and failed to get package context, then
     *                       a dialog will
     *                       be shown which when dismissed will exit the app.
     * @param helpUrl        The help user to add to
     *                       {@link R.string#error_get_package_context_failed_help_url_message}.
     * @return Returns the {@link Context}. This will {@code null} if an exception
     *         is raised.
     */
    @Nullable
    ...
    /**
     * Get the {@link PackageInfo} for the package associated with the
     * {@code context}.
     *
     * @param context The {@link Context} for the package.
     * @return Returns the {@link PackageInfo}. This will be {@code null} if an
     *         exception is raised.
     */
     ...
     * {@code packageName}.
     *
     * Also check {@link #isAppInstalled(Context, String, String) if targetting
     * targeting sdk
     * `30` (android `11`) since {@link PackageManager.NameNotFoundException} may be
     * thrown.
     *
     * @param context     The {@link Context} for operations.
     * @param packageName The package name of the package.
     ...
     * @param context     The {@link Context} for operations.
     * @param packageName The package name of the package.
     * @return Returns the {@link ApplicationInfo}. This will be {@code null} if an
     *         exception is raised.
     */
    @Nullable
    public static ApplicationInfo getApplicationInfoForPackage(@NonNull final Context context,
            @NonNull final String packageName) {
     ...
     * @param packageName The package name of the package.
     * @param flags       The flags to pass to
     *                    {@link PackageManager#getApplicationInfo(String, int)}.
     * @return Returns the {@link ApplicationInfo}. This will be {@code null} if an
     *         exception is raised.
     */
    @Nullable
    ...
    /**
     * Get the {@code privateFlags} {@link Field} of the {@link ApplicationInfo}
     * class.
     *
     ...
     *
     * String retrieved from the seinfo tag found in selinux policy. This value can
     * be set through
     * the mac_permissions.xml policy construct. This value is used for setting an
     * SELinux security
    ...
    /**
     * Get the {@code seInfoUser} {@link Field} of the {@link ApplicationInfo}
     * class.
     *
     * Also check {@link #getApplicationInfoSeInfoForPackage(ApplicationInfo)}.
     *
     * @param applicationInfo The {@link ApplicationInfo} for the package.
     * @return Returns the selinux info user or {@code null} if an exception was
     *         raised.
     */
    @Nullable
    ...
    /**
     * Check if the app associated with the {@code applicationInfo} has a specific
     * flag set.
     *
     * @param flagToCheckName The name of the field for the flag to check.
     * @param applicationInfo The {@link ApplicationInfo} for the package.
     * @return Returns {@code true} if app has flag is set, otherwise {@code false}.
     *         This will be
     *         {@code null} if an exception is raised.
     */
    @Nullable
    public static Boolean isApplicationInfoPrivateFlagSetForPackage(@NonNull String flagToCheckName,
    ...
    /**
     * Get the package name for the package associated with the
    ...
    /**
     * Get the {@code targetSdkVersion} for the package associated with the
     * {@code context}.
     *
     * @param context The {@link Context} for the package.
    ...
    /**
     * Get the base apk path for the package associated with the
     * {@code applicationInfo}.
     *
     * @param applicationInfo The {@link ApplicationInfo} for the package.
     * @return Returns the base apk path.
     ...
     * {@link ApplicationInfo#FLAG_DEBUGGABLE}
     * set.
     *
     * @param context The {@link Context} for the package.
    ...
    /**
     * Check if the app associated with the {@code context} has
     * {@link ApplicationInfo#FLAG_EXTERNAL_STORAGE}
     * set.
     *
     * @param context The {@link Context} for the package.
     * @return Returns {@code true} if app is installed on external storage,
     ...
     *
     * @param context The {@link Context} for the package.
     * @return Returns {@code true} if app has requested legacy external storage,
     *         otherwise
    ...
    /**
     * Get the {@code versionCode} for the package associated with the
     * {@code context}.
     *
     * @param context The {@link Context} for the package.
     * @return Returns the {@code versionCode}. This will be {@code null} if an
     *         exception is raised.
     */
    @Nullable
    ...
    /**
     * Get the {@code versionName} for the package associated with the
     * {@code context}.
     *
     * @param context The {@link Context} for the package.
     * @return Returns the {@code versionName}. This will be {@code null} if an
     *         exception is raised.
     */
    @Nullable
    ...
    /**
     * Get the {@code SHA-256 digest} of signing certificate for the package
     * associated with the {@code context}.
     *
     * @param context The {@link Context} for the package.
     * @return Returns the {@code SHA-256 digest}. This will be {@code null} if an
     *         exception is raised.
     */
    @Nullable
    ...
    /**
     * Get the {@code SHA-256 digest} of signing certificate for the
     * {@code packageName}.
     *
     * @param context     The {@link Context} for operations.
     * @param packageName The package name of the package.
    ...
    public static String getSigningCertificateSHA256DigestForPackage(@NonNull final Context context,
        ...
        try {
            /*
             * Todo: We may need AndroidManifest queries entries if package is installed but
             * with a different signature on android 11
             * https://developer.android.com/training/package-visibility
             * Need a device that allows (manual) installation of apk with mismatched
             * signature of
             * sharedUserId apps to test. Currently, if its done, PackageManager just
             * doesn't load
             * the package and removes its apk automatically if its installed as a user app
             * instead of system app
             * W/PackageManager: Failed to parse
             * /path/to/com.termux.tasker.apk:
             * Signature mismatch for shared user: SharedUserSetting{xxxxxxx
             * com.cs.ide/10xxx}
             */
    ...
    /**
     * Get the serial number for the user for the package associated with the
     * {@code context}.
     *
     * @param context The {@link Context} for the package.
     * @return Returns the serial number. This will be {@code null} if failed to get
     *         it.
     */
    ...
    /**
     * Check if the current user is the primary user. This is done by checking if
     * the the serial
     * number for the current user equals 0.
     *
     * @param context The {@link Context} for operations.
     * @return Returns {@code true} if the current user is the primary user,
     *         otherwise [@code false}.
     */
    @RequiresApi(api = Build.VERSION_CODES.N)
     ...
     *
     * @param context The {@link Context} for operations.
     * @return Returns the profile owner package name. This will be {@code null} if
     *         failed to get it
    ...
    /**
     * Get the process id of the main app process of a package. This will work for
     * sharedUserId. Note
     * that some apps have multiple processes for the app like with
    ...
    /**
     * Check if app is installed and enabled. This can be used by external apps that
     * don't
     * share `sharedUserId` with the an app.
     *
     * If your third-party app is targeting sdk `30` (android `11`), then it needs
     * to add package
     * name to the `queries` element or request `QUERY_ALL_PACKAGES` permission in
     * its
     * `AndroidManifest.xml`. Otherwise it will get `PackageSetting{......
     * package_name/......} BLOCKED`
     * errors in `logcat` and {@link PackageManager.NameNotFoundException} may be
     * thrown.
     ...
     * @param packageName The package name of the package.
     * @return Returns {@code errmsg} if {@code packageName} is not installed or
     *         disabled, otherwise {@code null}.
     */
    ...
    /**
     * Wrapper for
     * {@link #setComponentState(Context, String, String, boolean, String, boolean, boolean)}
     * with
     ...
     * @param toastString      If this is not {@code null} or empty, then a toast
     *                         before setting state.
     * @param showErrorMessage If an error message toast should be shown.
     * @param alwaysShowToast  If toast should always be shown even if current state
     *                         matches new state.
    ...
    /**
     * Check if state of a {@link ComponentName} is
     ...
     * @return Returns {@code true} if disabled, {@code false} if not and
     *         {@code null} if failed to
     *         get the state.
     */
    public static Boolean isComponentDisabled(@NonNull final Context context, @NonNull String packageName,
        ...
        try {
            ...
            if (packageManager != null) {
                ComponentName componentName = new ComponentName(packageName, className);
                // Will throw IllegalArgumentException: Unknown component: ComponentInfo{} if
                // app
    ...
    /**
     * Check if an {@link android.app.Activity} {@link ComponentName} can be called
     * by calling
