package com.cs.ide.termux.shared.termux.settings.preferences;
...
/**
 * A class that defines shared constants of the SharedPreferences used by Termux
 * app and its plugins.
...
public final class TermuxPreferenceConstants {
    ...
    public static final class TERMUX_APP {
        ...
        /**
         * Defines the key for whether terminal view margin adjustment that is done to
         * prevent soft
         * keyboard from covering bottom part of terminal view on some devices is
         * enabled or not.
         * Margin adjustment may cause screen flickering on some devices and so should
         * be disabled.
         */
        ...
        /**
         * Defines the key for whether to show terminal toolbar containing extra keys
        ...
        /**
         * Defines the key for whether the soft keyboard will be enabled, for cases
         * where users want
        ...
        /**
         * Defines the key for whether the soft keyboard will be enabled only if no
         * hardware keyboard
        ...
        /**
         * The {@link ExecutionCommand.Runner#APP_SHELL} number after termux app process
         * since boot.
         */
        ...
        /**
         * The {@link ExecutionCommand.Runner#TERMINAL_SESSION} number after termux app
         * process since boot.
         */
        ...
        /**
         * Defines the key for whether termux terminal view key logging is enabled or
         * not
         */
        ...
        /**
         * Defines the key for whether flashes and notifications for plugin errors are
         * enabled or not.
         */
        ...
        /**
         * Defines the key for whether notifications for crash reports are enabled or
         * not.
         */
