...
public class TermuxBootstrap {
    ...
    /**
     * The {@link PackageManager} for the bootstrap in the app APK added in
     * app/build.gradle.
     */
    public static PackageManager TERMUX_APP_PACKAGE_MANAGER;

    /**
     * The {@link PackageVariant} for the bootstrap in the app APK added in
     * app/build.gradle.
     */
    public static PackageVariant TERMUX_APP_PACKAGE_VARIANT;

    /**
     * Set {@link #TERMUX_APP_PACKAGE_VARIANT} and
    ...
    public static void setTermuxPackageManagerAndVariant(@Nullable String packageVariantName) {
        ...
        // Set packageManagerName to substring before first dash "-" in
        // packageVariantName
    ...
    /**
     * Set {@link #TERMUX_APP_PACKAGE_VARIANT} and
     * {@link #TERMUX_APP_PACKAGE_MANAGER} with the
     * {@link #BUILD_CONFIG_FIELD_TERMUX_PACKAGE_VARIANT} field value from the
     * {@link TERMUX_APP#BUILD_CONFIG_CLASS_NAME} class of the Termux app APK
    ...
    /**
     * Is {@link PackageVariant#APT_ANDROID_7} set as
     * {@link #TERMUX_APP_PACKAGE_VARIANT}.
     */
    ...
    /**
     * Is {@link PackageVariant#APT_ANDROID_5} set as
     * {@link #TERMUX_APP_PACKAGE_VARIANT}.
     */
    ...
    /// ** Is {@link PackageVariant#TAPM_ANDROID_7} set as
    /// {@link #TERMUX_APP_PACKAGE_VARIANT}. * /
    ...
    /// ** Is {@link PackageVariant#PACMAN_ANDROID_7} set as
    /// {@link #TERMUX_APP_PACKAGE_VARIANT}. * /
    ...
    public enum PackageManager {
        ...
        /**
         * Advanced Package Tool (APT) for managing debian deb package jniLibs.
        ...
        /// **
        // * Termux Android Package Manager (TAPM) for managing termux apk package
        /// jniLibs.
        ...
        /// **
        // * Package Manager (PACMAN) for managing arch linux pkg.tar package jniLibs.
    ...
    /**
     * Termux package variant. The substring before first dash "-" must match one of
