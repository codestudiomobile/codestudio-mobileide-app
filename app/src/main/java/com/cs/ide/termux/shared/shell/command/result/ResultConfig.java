...
public class ResultConfig {
    ...
    /**
     * Defines {@link PendingIntent} that should be sent with the result of the
     * command. We cannot
     * implement {@link java.io.Serializable} because {@link PendingIntent} cannot
     * be serialized.
     */
    public PendingIntent resultPendingIntent;
    /**
     * The key with which to send result {@link android.os.Bundle} in
     * {@link #resultPendingIntent}.
     */
    public String resultBundleKey;
    /**
     * The key with which to send {@link ResultData#stdout} in
     * {@link #resultPendingIntent}.
     */
    public String resultStdoutKey;
    /**
     * The key with which to send {@link ResultData#stderr} in
     * {@link #resultPendingIntent}.
     */
    public String resultStderrKey;
    /**
     * The key with which to send {@link ResultData#exitCode} in
     * {@link #resultPendingIntent}.
     */
    public String resultExitCodeKey;
    /**
     * The key with which to send {@link ResultData#errorsList} errCode in
     * {@link #resultPendingIntent}.
     */
    public String resultErrCodeKey;
    /**
     * The key with which to send {@link ResultData#errorsList} errmsg in
     * {@link #resultPendingIntent}.
     */
    public String resultErrmsgKey;
    /**
     * The key with which to send original length of {@link ResultData#stdout} in
     * {@link #resultPendingIntent}.
     */
    public String resultStdoutOriginalLengthKey;
    /**
     * The key with which to send original length of {@link ResultData#stderr} in
     * {@link #resultPendingIntent}.
     */
    ...
    /**
     * Defines the directory path under which {@link #resultDirectoryPath} can
     * exist.
     */
    ...
    /**
     * Defines the basename of the result file that should be created in
     * {@link #resultDirectoryPath}
     * if {@link #resultSingleFile} is {@code true}.
     */
    public String resultFileBasename;
    /**
     * Defines the output {@link Formatter} format of the
     * {@link #resultFileBasename} result file.
     */
    public String resultFileOutputFormat;
    /**
     * Defines the error {@link Formatter} format of the {@link #resultFileBasename}
     * result file.
     */
    public String resultFileErrorFormat;
    /**
     * Defines the suffix of the result jniLibs that should be created in
     * {@link #resultDirectoryPath}
     * if {@link #resultSingleFile} is {@code true}.
     */
     ...
     * @param ignoreNull   Set to {@code true} if non-critical {@code null} values
     *                     are to be ignored.
