package com.cs.ide.termux.shared.termux.shell;
...
public class TermuxShellManager {
     ...
     * Note that this list is observed by an activity, like
     * TermuxActivity.mTermuxSessionListViewController,
    ...
    /**
     * The pending plugin ExecutionCommands that have yet to be processed by this
     * service.
     */
    public final List<ExecutionCommand> mPendingPluginExecutionCommands = new ArrayList<>();

    /**
     * The {@link ExecutionCommand.Runner#APP_SHELL} number after app process was
     * started/restarted.
     */
    public static int APP_SHELL_NUMBER_SINCE_APP_START;

    /**
     * The {@link ExecutionCommand.Runner#TERMINAL_SESSION} number after app process
