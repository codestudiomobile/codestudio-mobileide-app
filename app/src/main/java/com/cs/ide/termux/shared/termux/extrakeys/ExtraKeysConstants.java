...
public class ExtraKeysConstants {
	...
	/**
	 * Defines the repetitive keys that can be passed to
	 * {@link ExtraKeysView#setRepetitiveKeys(List)}.
	 */
		...
		public static final ExtraKeyDisplayMap WELL_KNOWN_CHARACTERS_DISPLAY = new ExtraKeyDisplayMap() {
			{
				...
				put("PASTE", "⎘"); // U+2398
				put("SCROLL", "↕"); // U+2195 UP DOWN ARROW
			}
		};
		...
		public static final ExtraKeyDisplayMap LESS_KNOWN_CHARACTERS_DISPLAY = new ExtraKeyDisplayMap() {
			{
				...
				// home key can mean "goto the beginning of line" or "goto first page" depending
				// on context, hence the diagonal
		...
		public static final ExtraKeyDisplayMap NOT_KNOWN_ISO_CHARACTERS = new ExtraKeyDisplayMap() {
			{
				...
				put("CTRL", "⎈"); // ISO character "U+2388 ⎈ HELM SYMBOL" is unknown to people and never printed
				// on computers, however "U+25C7 ◇ WHITE DIAMOND" is a nice presentation, and
				// "^" for terminal app and mac is often used
				put("ALT", "⎇"); // ISO character "U+2387 ⎇ ALTERNATIVE KEY SYMBOL'" is unknown to people and
				// only printed as the Option key "⌥" on Mac computer
				put("ESC", "⎋"); // ISO character "U+238B ⎋ BROKEN CIRCLE WITH NORTHWEST ARROW" is unknown to
