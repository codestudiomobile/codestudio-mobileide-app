package com.cs.ide.termux.shared.data;
...
public class DataUtils {
    ...
    /**
     * Max safe limit of data size to prevent TransactionTooLargeException when
     * transferring data
     ...
     * @return Returns the {@code float} value after parsing the {@link String}
     *         value, otherwise
     *         returns default if failed to read a valid value, like in case of an
     *         exception.
     */
     ...
     * @return Returns {@code value} if it is not {@code null}, otherwise returns
     *         {@code def}.
     */
     ...
     * @return Returns the {@code int} value after parsing the {@link String} value
     *         stored in
     *         {@link Bundle}, otherwise returns default if failed to read a valid
     *         value,
    ...
    /**
     * Add a space indent to a {@link String}. Each indent is 4 space characters
     * long.
     *
    ...
    /**
     * Get the {@link String} itself if it is not {@code null} or empty, otherwise
     * default.
     *
     * @param value The {@link String} to check.
     * @param def   The default {@link String}.
     * @return Returns {@code value} if it is not {@code null} or empty, otherwise
     *         returns {@code def}.
     */
