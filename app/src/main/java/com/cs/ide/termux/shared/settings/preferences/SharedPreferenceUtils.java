package com.cs.ide.termux.shared.settings.preferences;
...
public class SharedPreferenceUtils {
    ...
    /**
     * Get {@link SharedPreferences} instance of the preferences file 'name' with
     * the operating mode
     * {@link Context#MODE_PRIVATE}. This file will be created in the app package's
     * default
     * shared preferences directory.
     *
     * @param context The {@link Context} to get the {@link SharedPreferences}
     *                instance.
     ...
     * Get {@link SharedPreferences} instance of the preferences file 'name' with
     * the operating mode
     * {@link Context#MODE_PRIVATE} and {@link Context#MODE_MULTI_PROCESS}. This
     * file will be
     ...
     * @return Returns the {@code boolean} value stored in
     *         {@link SharedPreferences}, otherwise returns
     *         default if failed to read a valid value, like in case of an
     *         exception.
     */
     ...
     * @param commitToFile      If set to {@code true}, then value will be set to
     *                          shared preferences
     *                          in-memory cache and the file synchronously. Ideally,
     *                          only to be used for
     ...
     * @param key               The key for the value.
     * @param def               The default value if failed to read a valid value.
     * @return Returns the {@code float} value stored in {@link SharedPreferences},
     *         otherwise returns
     *         default if failed to read a valid value, like in case of an
     *         exception.
     */
     ...
     * @param key               The key for the value.
     * @param def               The default value if failed to read a valid value.
     * @return Returns the {@code int} value stored in {@link SharedPreferences},
     *         otherwise returns
     *         default if failed to read a valid value, like in case of an
     *         exception.
     */
     ...
     *                          only to be used for
     *                          multi-process use-cases.
     * @param resetValue        The value if not {@code null} that should be set if
     *                          current or incremented
     *                          value is less than 0.
     * @return Returns the {@code int} value stored in {@link SharedPreferences}
     *         before increment,
     *         otherwise returns default if failed to read a valid value, like in
     ...
     * @param key               The key for the value.
     * @param def               The default value if failed to read a valid value.
     * @return Returns the {@code long} value stored in {@link SharedPreferences},
     *         otherwise returns
     *         default if failed to read a valid value, like in case of an
     *         exception.
     */
     ...
     * @param key               The key for the value.
     * @param def               The default value if failed to read a valid value.
     * @param defIfEmpty        If set to {@code true}, then {@code def} will be
     *                          returned if value is empty.
     * @return Returns the {@code String} value stored in {@link SharedPreferences},
     *         otherwise returns
     *         default if failed to read a valid value, like in case of an
     *         exception.
     */
     ...
     * @param key               The key for the value.
     * @param def               The default value if failed to read a valid value.
     * @return Returns the {@code Set<String>} value stored in
     *         {@link SharedPreferences}, otherwise returns
     *         default if failed to read a valid value, like in case of an
     *         exception.
     */
    ...
    /**
     * Get an {@code int} from {@link SharedPreferences} that is stored as a
     * {@link String}.
     *
     * @param sharedPreferences The {@link SharedPreferences} to get the value from.
     * @param key               The key for the value.
     * @param def               The default value if failed to read a valid value.
     * @return Returns the {@code int} value after parsing the {@link String} value
     *         stored in
     *         {@link SharedPreferences}, otherwise returns default if failed to
     *         read a valid value,
    ...
    /**
     * Set an {@code int} into {@link SharedPreferences} that is stored as a
     * {@link String}.
     *
     * @param sharedPreferences The {@link SharedPreferences} to set the value in.
     * @param key               The key for the value.
