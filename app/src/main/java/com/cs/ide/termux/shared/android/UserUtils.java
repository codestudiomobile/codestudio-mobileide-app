...
public class UserUtils {
    ...
    /**
     * Get the user name for user id with a call to
     * {@link #getNameForUidFromPackageManager(Context, int)}
    ...
    /**
     * Get the user name for user id with a call to
     * {@link PackageManager#getNameForUid(int)}.
     *
     * This will not return user names for non app user id like for root user 0, use
     * {@link #getNameForUidFromLibcore(int)}
     * to get those.
     *
     ...
     *
     * This will return user names for non app user id like for root user 0 as well,
     * but this call
     ...
     *
     * `BlockGuardOs` implements the `Os` interface and its instance is stored in
     * `Libcore` class static `os` field.
     * The `getpwuid` method is implemented by `ForwardingOs`, which is the super
     * class of `BlockGuardOs`.
     * The `getpwuid` method returns `StructPasswd` object whose `pw_name` contains
     * the user name for id.
     *
