...
public class ProcessUtils {
    ...
    /**
     * Get the app process name for a pid with a call to
     * {@link ActivityManager#getRunningAppProcesses()}.
     *
     * This will not return child process names. Android did not keep track of them
     * before android 12
     * phantom process addition, but there is no API via IActivityManager to get
     * them.
     *
     * To get process name for pids of own app's child processes, check
