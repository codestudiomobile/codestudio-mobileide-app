...
import com.cs.ide.termux.shared.termux.terminal.io.BellHandler;
import com.cs.ide.termux.terminal.TerminalColors;
import com.cs.ide.termux.terminal.TerminalSession;
import com.cs.ide.termux.terminal.TerminalSessionClient;
import com.cs.ide.termux.terminal.TextStyle;
...
public class TermuxTerminalSessionActivityClient extends TermuxTerminalSessionClientBase {
	...
	private synchronized void loadBellSoundPool() {
		if (mBellSoundPool == null) {
			...
			try {
				mBellSoundId = mBellSoundPool.load(mActivity, com.cs.ide.R.raw.bell, 1);
			} catch (Exception e) {
				// Catch java.lang.RuntimeException: Unable to resume activity {com.termux/com.cs.ide.termux.app.TermuxActivity}: android.content.res.Resources$NotFoundException: File res/raw/bell.ogg from drawable resource ID
