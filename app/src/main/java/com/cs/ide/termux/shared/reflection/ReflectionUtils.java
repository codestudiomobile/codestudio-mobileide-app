package com.cs.ide.termux.shared.reflection;
...
public class ReflectionUtils {
     ...
     * @return Returns the {@link Field} if getting the it was successful, otherwise
     *         {@code null}.
     */
    @Nullable
     ...
     * @param fieldName The name of the {@link Field}.
     * @param object    The {@link Object} instance from which to get the field
     *                  value.
     * @return Returns the {@link FieldInvokeResult} of invoking the field. The
     *         {@link FieldInvokeResult#success} will be {@code true} if invoking
     *         the field was successful,
     *         otherwise {@code false}. The {@link FieldInvokeResult#value} will
     *         contain the field
     *         {@link Object} value.
     */
    @NonNull
    public static <T> FieldInvokeResult invokeField(@NonNull Class<? extends T> clazz, @NonNull String fieldName,
            T object) {
        try {
    ...
    /**
     * Wrapper for {@link #getDeclaredMethod(Class, String, Class[])} without
     * parameters.
     */
    @Nullable
     ...
     * @return Returns the {@link Method} if getting the it was successful,
     *         otherwise {@code null}.
     */
    @Nullable
    public static Method getDeclaredMethod(@NonNull Class<?> clazz, @NonNull String methodName,
    ...
    /**
     * Wrapper for {@link #invokeVoidMethod(Method, Object, Object...)} without
     * arguments.
     */
     ...
     * @return Returns {@code true} if invoking the method was successful, otherwise
     *         {@code false}.
     */
    ...
    /**
     * Class that represents result of invoking a method that has a non-void return
     * type.
     */
    ...
    /**
     * Wrapper for {@link #invokeMethod(Method, Object, Object...)} without
     * arguments.
     */
    @NonNull
     ...
     *         {@link MethodInvokeResult#success} will be {@code true} if invoking
     *         the method was successful,
     *         otherwise {@code false}. The {@link MethodInvokeResult#value} will
     *         contain the {@link Object}
    ...
    /**
     * Wrapper for {@link #getConstructor(Class, Class[])} to get a
     * {@link Constructor} for the
     * {@code className}.
     */
    @Nullable
    ...
    /**
     * Get a {@link Constructor} for the specified class with the specified
     * parameters.
     *
     * @param clazz          The {@link Class} for which to return the constructor.
     * @param parameterTypes The parameter types of the constructor.
     * @return Returns the {@link Constructor} if getting the it was successful,
     *         otherwise {@code null}.
     */
    @Nullable
    ...
    /**
     * Wrapper for {@link #invokeConstructor(Constructor, Object...)} without
     * arguments.
     */
    @Nullable
     ...
     * @return Returns the new instance if invoking the constructor was successful,
     *         otherwise {@code null}.
     */
    @Nullable
