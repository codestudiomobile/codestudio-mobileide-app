package com.cs.ide.termux.shared.file.tests;
...
public class FileUtilsTests {
     ...
     * FileUtilsTests.runTests(this, TermuxConstants.TERMUX_HOME_DIR_PATH +
     * "/FileUtilsTests");
     *
    ...
    private static void runTestsInner(@NonNull final String testRootDirectoryPath) throws Exception {
        ...
        // This is to ensure that symlinkFileExists returns true if a symlink file
        // exists but is dangling
        label = dir1__sub_sym3_label;
        path = dir1__sub_sym3_path;
        ...
        // since it was a symlink to dir2
        ...
        // Check if dir2 directory file and dir2/sub_reg1 regular file still exist after
        // deletion of
        // dir1 since there was a dir1/sub_sym1 symlink to dir2 in it
        // When deleting a directory, any targets of symlinks must not be deleted when
        // deleting symlink jniLibs
        label = dir2_label;
        path = dir2_path;
        if (!FileUtils.directoryFileExists(path, false))
            throwException(
