...
import com.cs.ide.R;
import com.cs.ide.app.DisplayManager;
...
import com.cs.ide.termux.shared.termux.settings.preferences.TermuxAPIAppSharedPreferences;
import com.cs.ide.termux.shared.termux.settings.preferences.TermuxFloatAppSharedPreferences;
import com.cs.ide.termux.shared.termux.settings.preferences.TermuxTaskerAppSharedPreferences;
import com.cs.ide.termux.shared.termux.settings.preferences.TermuxWidgetAppSharedPreferences;
...
public class SettingsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ViewCompat.setOnApplyWindowInsetsListener(settingsLayout, DisplayManager::setupDynamicMarginHandling);

        if (savedInstanceState == null) {
            getSupportFragmentManager().beginTransaction().replace(R.id.settings, new RootPreferencesFragment())
                    .commit();
        }
    ...
    // Assume ADDTIONAL_MARGIN_DP is a defined constant, e.g., 50
                ...
                aboutPreference.setOnPreferenceClickListener(preference -> {
                    new Thread() {
                        ...
                        public void run() {
                            ...
                            String aboutString = TermuxUtils.getAppInfoMarkdownString(context,
