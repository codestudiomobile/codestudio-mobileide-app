...
import com.cs.ide.termux.terminal.TerminalBuffer;
import com.cs.ide.termux.terminal.TerminalEmulator;
import com.cs.ide.termux.terminal.TerminalRow;
import com.cs.ide.termux.terminal.TextStyle;
import com.cs.ide.termux.terminal.WcWidth;

/**
 * Renderer of a {@link TerminalEmulator} into a {@link Canvas}.
 * <p/>
 * Saves font metrics, so needs to be recreated each time the typeface or font
 * size changes.
 */
public final class TerminalRenderer {
	...
	/**
	 * Render the terminal to a canvas with at a specified row scroll, and an
	 * optional rectangular selection.
	 */
	...
	private void drawTextRun(Canvas canvas, char[] text, int[] palette, float y, int startColumn, int runWidthColumns,
		...
		if (insideSelection) {
			mTextPaint.setColor(0xFFFFFFFF); // Solid white selection background
			canvas.drawRect(left, y - mFontLineSpacing, right, y, mTextPaint);
			foreColor = 0xFF000000; // Black text inside selection
		} else if (backColor != palette[TextStyle.COLOR_INDEX_BACKGROUND]) {
