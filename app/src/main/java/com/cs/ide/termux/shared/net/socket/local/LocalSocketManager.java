package com.cs.ide.termux.shared.net.socket.local;

import static com.cs.tmx.shared.net.socket.local.LocalSocketManager.acceptNative;
import static com.cs.tmx.shared.net.socket.local.LocalSocketManager.availableNative;
import static com.cs.tmx.shared.net.socket.local.LocalSocketManager.closeSocketNative;
import static com.cs.tmx.shared.net.socket.local.LocalSocketManager.createServerSocketNative;
import static com.cs.tmx.shared.net.socket.local.LocalSocketManager.getPeerCredNative;
import static com.cs.tmx.shared.net.socket.local.LocalSocketManager.readNative;
import static com.cs.tmx.shared.net.socket.local.LocalSocketManager.sendNative;
import static com.cs.tmx.shared.net.socket.local.LocalSocketManager.setSocketReadTimeoutNative;
import static com.cs.tmx.shared.net.socket.local.LocalSocketManager.setSocketSendTimeoutNative;
