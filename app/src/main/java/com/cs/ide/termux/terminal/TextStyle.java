 ...
 * are stored for each cell in a terminal
...
public final class TextStyle {
    ...
    /**
     * The selective erase control functions (DECSED and DECSEL) can only erase
     * characters defined as erasable.
     * <p>
     * This bit is set if DECSCA (Select Character Protection Attribute) has been
     * used to define the characters that
    ...
    /**
     * The 256 standard color entries and the three special (foreground, background
     * and cursor) ones.
     */
