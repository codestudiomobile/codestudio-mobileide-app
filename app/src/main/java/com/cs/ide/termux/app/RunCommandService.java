...
public class RunCommandService extends Service {
    ...
    public int onStartCommand(Intent intent, int flags, int startId) {
        ...
        if (replaceCommaAlternativeCharsInArguments) {
            ...
            if (commaAlternativeCharsInArguments == null) commaAlternativeCharsInArguments = TermuxConstants.COMMA_ALTERNATIVE;
        ...
        // If executable is null or empty, then exit here instead of getting canonical path
        ...
        // Validate regular file existence and permissions
        ...
        // If workingDirectory is set, validate it
        ...
        // Handle applets for coreutils/busybox (symlinks)
        ...
        // Create execution intent to be sent to the TERMUX_SERVICE
