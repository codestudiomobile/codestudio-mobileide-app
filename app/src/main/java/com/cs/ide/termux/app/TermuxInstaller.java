...
public final class TermuxInstaller {
		...
		if (FileUtils.directoryFileExists(TERMUX_PREFIX_DIR_PATH, true)) {
			if (TermuxFileUtils.isTermuxPrefixDirectoryEmpty()) {
				...
				if (lastBootstrappedVersion != currentVersion) {
					Logger.logInfo(LOG_TAG, "The termux prefix directory \"" + TERMUX_PREFIX_DIR_PATH + "\" exists but app version changed from " + lastBootstrappedVersion + " to " + currentVersion + ". Redoing bootstrap setup.");
				} else {
	...
	public static byte[] loadZipBytes() {
		...
		return com.cs.tmx.app.TermuxInstaller.getZip();
	}
