...
public class UnixConstants {
    ...
    // Crash on Android 5.
    // No static field O_DSYNC of type I in class Landroid/system/OsConstants; or
    // its superclasses
    // (declaration of 'android.system.OsConstants' appears in
    ...
    // S_IAMB are access mode bits, therefore, calculated by taking OR of all the
    // read, write and
    ...
    // END Android-changed: Use constants from android.system.OsConstants.
    // http://b/32203242
