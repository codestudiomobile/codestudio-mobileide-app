...
public interface CursorController extends ViewTreeObserver.OnTouchModeChangeListener {
    /**
     * Show the cursors on screen. Will be drawn by {@link #render()} by a call
     * during onDraw.
     * See also {@link #hide()}.
     */
    ...
    /**
     * This method is called by {@link #onTouchEvent(MotionEvent)} and gives the
     * cursors
    ...
    /**
     * Called when the view is detached from window. Perform house keeping task,
     * such as
     * stopping Runnable thread that would otherwise keep a reference on the
     * context, thus
