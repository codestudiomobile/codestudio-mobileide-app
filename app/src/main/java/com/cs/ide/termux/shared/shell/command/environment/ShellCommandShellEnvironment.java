...
public class ShellCommandShellEnvironment {
        ...
        /**
         * Environment variable for the package name running the
         ...
         * {@link ExecutionCommand#id}/TermuxShellManager.SHELL_ID name.
        ...
        /**
         * Environment variable for the {@link ExecutionCommand.Runner#APP_SHELL} number
         * since boot.
         */
        ...
        /**
         * Environment variable for the
         * {{@link ExecutionCommand.Runner#TERMINAL_SESSION} number since boot.
         */
        ...
        /**
         * Environment variable for the {@link ExecutionCommand.Runner#TERMINAL_SESSION}
         * number since app start.
         */
        ...
        public HashMap<String, String> getEnvironment(@NonNull Context currentPackageContext,
                ...
                ShellEnvironmentUtils.putToEnvIfSet(environment, ENV_SHELL_CMD__SHELL_ID,
                                String.valueOf(executionCommand.id));
