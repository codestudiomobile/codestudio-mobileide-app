...
public class AndroidShellEnvironment extends UnixShellEnvironment {
    ...
    public HashMap<String, String> getEnvironment(@NonNull Context currentPackageContext, boolean isFailSafe) {
        ...
        // Samsung S7 - see
        // https://plus.google.com/110070148244138185604/posts/gp8Lk3aCGp3.
    ...
    public HashMap<String, String> setupShellCommandEnvironment(@NonNull Context currentPackageContext,
        ...
        environment.put(ENV_PWD,
                workingDirectory != null && !workingDirectory.isEmpty() ? new File(workingDirectory).getAbsolutePath() : // PWD
                                                                                                                         // must
                                                                                                                         // be
                                                                                                                         // absolute
                                                                                                                         // path
