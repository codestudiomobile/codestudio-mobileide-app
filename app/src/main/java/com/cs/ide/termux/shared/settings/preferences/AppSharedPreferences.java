...
public class AppSharedPreferences {
    ...
    /**
     * The {@link SharedPreferences} that ideally should be created with
     * {@link SharedPreferenceUtils#getPrivateSharedPreferences(Context, String)}.
     */
    protected final SharedPreferences mSharedPreferences;

    /**
     * The {@link SharedPreferences}that ideally should be created with
     * {@link SharedPreferenceUtils#getPrivateAndMultiProcessSharedPreferences(Context, String)}.
     */
