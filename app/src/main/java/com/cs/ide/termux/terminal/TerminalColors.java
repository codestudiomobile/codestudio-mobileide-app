...
public final class TerminalColors {
    ...
    /**
     * The current terminal colors, which are normally set from the color theme, but
     * may be set dynamically with the OSC
     * 4 control sequence.
     */
    ...
    /**
     * Parse color according to
     * http://manpages.ubuntu.com/manpages/intrepid/man3/XQueryColor.3.html
     * <p/>
     * Highest bit is set if successful, so return value is 0xFF${R}${G}${B}. Return
     * 0 if failed.
     */
