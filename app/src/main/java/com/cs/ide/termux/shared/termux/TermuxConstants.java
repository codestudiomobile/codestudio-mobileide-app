...
public final class TermuxConstants {
	 ...
	 * Termux package name
	 */
	public static final String TERMUX_PACKAGE_NAME = "com.cs.ide"; // Default: "com.termux"
	/**
	...
	public static final class TERMUX_APP {
		...
		public static final class TERMUX_ACTIVITY {
			...
			/**
			 * Intent action to make termux app open a new window.
			 */
			public static final String ACTION_OPEN_NEW_WINDOW = TermuxConstants.TERMUX_PACKAGE_NAME + ".app.open_new_window"; // Default: "com.termux.app.open_new_window"
		}
		...
		public static final class TERMUX_SERVICE {
			...
			/**
			 * Intent {@code String} extra for custom log level for background commands defined by {@link com.cs.ide.termux.shared.logger.Logger} for the TERMUX_SERVICE.ACTION_SERVICE_EXECUTE intent
			 */
		...
		public static final class RUN_COMMAND_SERVICE {
			...
			/**
			 * Intent {@code String} extra for custom log level for background commands defined by {@link com.cs.ide.termux.shared.logger.Logger} for the RUN_COMMAND_SERVICE.ACTION_RUN_COMMAND intent
			 */
