...
public class TermuxTerminalSessionActivityClient extends TermuxTerminalSessionClientBase {
	...
	private synchronized void loadBellSoundPool() {
		if (mBellSoundPool == null) {
			...
			try {
				...
				// {com.csmide.app.termux/com.csmide.app.termux.app.TermuxActivity}:
	...
	public void addNewSession(boolean isFailSafe, String runCommand, String sessionName) {
		...
		if (service.getTermuxSessionsSize() >= MAX_SESSIONS) {
			...
			TermuxSession newTermuxSession = service.createTermuxSession(null, null, stdin, workingDirectory, isFailSafe,
					sessionName);
