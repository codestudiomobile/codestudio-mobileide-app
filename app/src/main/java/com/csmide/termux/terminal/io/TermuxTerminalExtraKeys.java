package com.csmide.termux.terminal.io;
...
import com.csmide.termux.shared.termux.settings.properties.TermuxSharedProperties;
    ...
    private void setExtraKeys() {
        ...
        try {
            ...
            Logger.showToast(mActivity, "Could not load and set the \"" + TermuxPropertyConstants.KEY_EXTRA_KEYS
                    + "\" property from the properties file: " + e, true);
