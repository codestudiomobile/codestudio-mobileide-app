package com.csmide.termux.shared.android.resource;
...
public class ResourceUtils {
	...
	/**
	 * Wrapper for {@link #getResourceId(Context, String, String, String, boolean)}
	 * without {@code defPackage}.
	 */
	@Nullable
	...
	/**
	 * Get resource identifier for the given resource name. A fully qualified
	 * resource name is of
	 * the form "package:type/entry". The first two components (package and type)
	 * are optional if
	 ...
	 * @param defPackage      Optional default package to find, if "package:" is not
	 *                        included in the name.
	 *                        Can be null to require an explicit package.
	 * @param logErrorMessage If an error message should be logged if failed to find
	 *                        resource.
	 * @return Returns the resource identifier if found. Otherwise {@code null} if
	 * an exception was
	 ...
	 * {@link #getResourceId(Context, String, String, String, boolean)}.
	 */
	@Nullable
	...
	/**
	 * Get resource identifier for the given {@link #RES_TYPE_DRAWABLE} resource
	 * name.
	 * <p>
	 * This is a wrapper for
	 * {@link #getResourceId(Context, String, String, String, boolean)}.
