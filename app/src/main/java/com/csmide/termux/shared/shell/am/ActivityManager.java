...
public class ActivityManager {
	...
	/**
	 * Result for IActivityManager.startVoiceActivity: active session is currently
	 * hidden.
	 *
	 * @hide
	 */
	...
	/**
	 * Result for IActivityManager.startActivity: trying to start an activity under
	 * voice
	...
	/**
	 * Result for IActivityManager.startAssistantActivity: active session is
	 * currently hidden.
	 *
	 * @hide
	 */
	...
	/**
	 * Result for IActivityManager.startAssistantActivity: active session does not
	 * match
	 * the requesting token.
	 *
	 * @hide
	...
	/**
	 * Result for IActivityManaqer.startActivity: the caller asked that the Intent
	 * not
	...
	/**
	 * Result for IActivityManaqer.startActivity: activity wasn't really started,
	 * but
	...
	/**
	 * Result for IActivityManaqer.startActivity: a new activity was attempted to be
	 * started
	...
	/**
	 * Result for IActivityManaqer.startActivity: a new activity start was aborted.
	 * Never returned
	 * externally.
	 *
	 * @hide
