...
public class CrossVersionReflectedMethod {
	 ...
	 * @param typesNamesAndDefaults any amount of (in order, all required for each
	 *                              set)
	 *                              - Types (as class, used in reflection)
	 *                              - Names (used for
	 *                              {@link #invoke(Object, Object...)} call)
	 *                              - Default values
	 */
	public CrossVersionReflectedMethod tryMethodVariant(String methodName, Object... typesNamesAndDefaults) {
		...
		try {
			...
			// Get method
			mMethod = mClass.getMethod(methodName, refArguments);
			...
			try {
				...
				for (Class<?> methodParam : method.getParameterTypes()) {
					...
					if (methodParam == expectedArgumentClass) {
						argNamesToIndexes.put((String) typesNamesAndDefaults[expectedArgumentI * 3 + 1],
								actualArgumentI);
	 ...
	 * Invoke method
	 *
	 * @param receiver       Object on which we call
	 *                       {@link Method#invoke(Object, Object...)}
	 * @param namesAndValues Any amount of argument name (as used in
	 *                       {@link #tryMethodVariant(String, Object...)} and value
	 *                       pairs
	 */
