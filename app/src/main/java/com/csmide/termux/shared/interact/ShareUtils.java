package com.csmide.termux.shared.interact;
...
public class ShareUtils {
	...
	/**
	 * Open the system app chooser that allows the user to select which app to send
	 * the intent.
	 *
	...
	/**
	 * Wrapper for {@link #copyTextToClipboard(Context, String, String, String)}
	 * with `null` `clipDataLabel` and `toastString`.
	 */
	 ...
	 *
	 * @param context       The context for operations.
	 * @param clipDataLabel The label to show to the user describing the copied
	 *                      text.
	 * @param text          The text to copy.
	 * @param toastString   If this is not {@code null} or empty, then a toast is
	 *                      shown if copying to
	...
	/**
	 * Wrapper for {@link #getTextFromClipboard(Context, boolean)} that returns
	 * primary text {@link String}
	 ...
	 *
	 * @param context      The context for operations.
	 * @param coerceToText Whether to call
	 *                     {@link ClipData.Item#coerceToText(Context)} to coerce
	 *                     non-text data to text.
	 * @return Returns the {@link CharSequence} of primary text. This will be `null`
	 * if failed to get it.
	 */
	@Nullable
	 ...
	 * or `/sdcard` and storage permission is missing, it will be requested if
	 * {@code context} is an
	 * instance of {@link Activity} or {@link AppCompatActivity} and
	 * {@code storagePermissionRequestCode}
	 * is `>=0` and the function will automatically return. The caller should call
	 * this function again
	 ...
	 * @param showToast                    If set to {@code true}, then a toast is
	 *                                     shown if saving to file is successful.
	 * @param storagePermissionRequestCode The request code to use while asking for
	 *                                     permission.
	 */
