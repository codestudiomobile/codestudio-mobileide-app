package com.csmide.termux.shared.models;
...
import com.csmide.termux.shared.activities.TextIOActivity;
 ...
 * {@link DataUtils#TRANSACTION_SIZE_LIMIT_IN_BYTES}. Larger size can be
 * supported for in-app
 * transactions by storing {@link TextIOInfo} as a serialized object in a file
 * like
...
public class TextIOInfo implements Serializable {
    ...
    /**
     * The label of text input set in {@link android.widget.TextView} that can be
     * updated by user.
    ...
    /**
     * The text of text input set in {@link android.widget.EditText} that can be
     * updated by user.
    ...
    /**
     * If editing text should be disabled so that text acts like its in a
