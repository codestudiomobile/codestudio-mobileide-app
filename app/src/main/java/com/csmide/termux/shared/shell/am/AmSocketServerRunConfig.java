...
public class AmSocketServerRunConfig extends LocalSocketRunConfig implements Serializable {
	...
	/**
	 * Check if {@link Manifest.permission#SYSTEM_ALERT_WINDOW} has been granted if
	 * running on Android `>= 10`
	 * if starting activities. Will also check when starting services in case
	 * starting foreground
	...
	/**
	 * Get {@link #mCheckDisplayOverAppsPermission} if set, otherwise
	 * {@link #DEFAULT_CHECK_DISPLAY_OVER_APPS_PERMISSION}.
	 */
	...
	public String getLogString() {
		...
		String logString = super.getLogString() + "\n\n\n" +
				"Am Command:" +
				"\n" + Logger.getSingleLineLogStringEntry("CheckDisplayOverAppsPermission",
