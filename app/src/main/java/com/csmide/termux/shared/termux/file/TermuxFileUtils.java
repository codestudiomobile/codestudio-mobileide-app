package com.csmide.termux.shared.termux.file;
...
import com.csmide.termux.shared.file.FileUtilsErrno;
...
public class TermuxFileUtils {
     ...
     * /data/user/0/com.csmide` as secondary user will result
     * in `ls: /data/user/0/com.csmide: Permission denied` where `0` is
     * primary user id but running
     * `/system/bin/ls -lhd /data/user/10/com.csmide` will result in
     * `drwx------ 6 u10_a149 u10_a149 4.0K 2021-xx-xx xx:xx
     * /data/user/10/com.csmide` where `10` is
