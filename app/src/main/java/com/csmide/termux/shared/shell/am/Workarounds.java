...
public class Workarounds {
    ...
    public static void applyMaybeAudio(boolean audio) {
        ...
        if (Build.BRAND.equalsIgnoreCase("meizu")) {
            ...
            //
            // But only apply when strictly necessary, since workarounds can cause other
            // issues:
            ...
            //
            // The system context must not be set for all devices, because it would cause
            // other problems:
        ...
        if (audio && Build.VERSION.SDK_INT == Build.VERSION_CODES.R) {
            ...
            // Only on Android 11 we must fill the application context for the AudioRecord
            // to work.
            mustFillAppContext = true;
        }
