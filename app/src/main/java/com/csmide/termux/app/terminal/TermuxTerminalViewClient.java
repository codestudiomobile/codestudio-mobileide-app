...
import com.csmide.termux.app.terminal.io.KeyboardShortcut;
...
public class TermuxTerminalViewClient extends TermuxTerminalViewClientBase {
	...
	/**
	 * Should be called when {@link com.csmide.termux.view.TerminalView#mEmulator} is set
	 */
	@Override
	...
	public void reportIssueFromTranscript() {
		...
		MessageDialogUtils.showMessage(mActivity, TermuxConstants.TERMUX_APP_NAME + " Report Issue",
				...
				mActivity.getString(com.csmide.R.string.action_yes), (dialog, which) -> reportIssueFromTranscript(transcriptText, true),
				mActivity.getString(com.csmide.R.string.action_no), (dialog, which) -> reportIssueFromTranscript(transcriptText, false),
				null);
	}
