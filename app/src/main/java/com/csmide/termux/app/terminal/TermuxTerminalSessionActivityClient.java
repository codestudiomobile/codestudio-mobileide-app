...
import com.csmide.termux.shared.termux.terminal.io.BellHandler;
import com.csmide.termux.terminal.TerminalColors;
import com.csmide.termux.terminal.TerminalSession;
import com.csmide.termux.terminal.TerminalSessionClient;
import com.csmide.termux.terminal.TextStyle;
...
public class TermuxTerminalSessionActivityClient extends TermuxTerminalSessionClientBase {
	...
	private synchronized void loadBellSoundPool() {
		if (mBellSoundPool == null) {
			...
			try {
				mBellSoundId = mBellSoundPool.load(mActivity, com.csmide.R.raw.bell, 1);
			} catch (Exception e) {
				// Catch java.lang.RuntimeException: Unable to resume activity {com.termux/com.csmide.termux.app.TermuxActivity}: android.content.res.Resources$NotFoundException: File res/raw/bell.ogg from drawable resource ID
