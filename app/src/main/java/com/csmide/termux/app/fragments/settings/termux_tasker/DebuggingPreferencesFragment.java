package com.csmide.termux.app.fragments.settings.termux_tasker;
...
import com.csmide.R;
import com.csmide.termux.shared.termux.settings.preferences.TermuxTaskerAppSharedPreferences;
...
public class DebuggingPreferencesFragment extends PreferenceFragmentCompat {
	...
	private void configureLoggingPreferences(@NonNull Context context) {
		...
		if (logLevelListPreference != null) {
			...
			com.csmide.termux.app.fragments.settings.termux.DebuggingPreferencesFragment
