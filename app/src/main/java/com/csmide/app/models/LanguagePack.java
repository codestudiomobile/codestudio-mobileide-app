...
public class LanguagePack {
	...
	/**
	 * The shell command used to uninstall the package.
	 */
	public final String uninstallCommand;
	/**
	 ...
	 * @param uninstallCommand The uninstallation command.
	 * @param checkCommand     The status check command.
	 * @param status           Initial status.
	 * @param type             Type of package (Runtime or Suggestion).
	 */
	public LanguagePack(String key, String name, String installCommand, String uninstallCommand, String checkCommand, int status, int type) {
		this.key = key;
		this.name = name;
	...
	/**
	 * Generates the command for uninstalling this package.
	 *
	 * @return The uninstallation command string.
	 */
	public String getUninstallCommand() {
		return uninstallCommand != null ? uninstallCommand : installCommand.replace("install", "uninstall");
	}
