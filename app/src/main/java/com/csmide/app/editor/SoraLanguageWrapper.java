...
/**
 * SoraLanguageWrapper wraps a Language and adds a CompletionProvider for snippets,
 * and also ensures symbol pair matching (auto-closing) is provided.
 */
public class SoraLanguageWrapper implements Language {
	private final Language base;
	private CompletionProvider autoCompleteProvider;
	private SymbolPairMatch symbolPairs;

	public SoraLanguageWrapper(Language base) {
		this.base = base;
		this.symbolPairs = new SymbolPairMatch.DefaultSymbolPairs();
	}

	public void setSymbolPairs(SymbolPairMatch pairs) {
		this.symbolPairs = pairs;
	}
	...
	public SymbolPairMatch getSymbolPairs() {
		SymbolPairMatch basePairs = base.getSymbolPairs();
		if (basePairs != null) {
			return basePairs;
		}
		return symbolPairs;
