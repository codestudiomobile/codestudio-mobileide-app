...
public class LanguageManagerService extends Service {
	public static final String ACTION_INSTALL_PACKAGE = "com.csmide.action.INSTALL_PACKAGE";
	...
	public static final String ACTION_PROGRESS_UPDATE = "com.csmide.action.PROGRESS_UPDATE";
	public static final String EXTRA_PROGRESS = "progress";
	public static final String EXTRA_STATUS_TEXT = "status_text";
	public static final String ACTION_REQUEST_CONFIRM = "com.csmide.action.PACKAGE_REQUEST_CONFIRM";
	public static final String ACTION_CONFIRM = "com.csmide.action.PACKAGE_CONFIRM";
